...
const (
	...
	HTTP_MultiLogin_UserIDReq = "Unnamed-Plan-User"
	HTTP_MultiLogin_TokenReq  = "Unnamed-Plan-Token"
	HTTP_MultiLogin_UserIDRes = "Unnamed-Plan-User-Res"
	HTTP_MultiLogin_TokenRes  = "Unnamed-Plan-Token-Res"
